...
// Public interface was ready in the program code base of the exercise.
...
private:
    ...
    // coordinates of the size of the map
    int x_, y_;

    // datastructure of a points
    map<string, class point*> pointsdata_;

    // datastructure of the orienteeringmap
    using Orienteermap = vector<vector<class point*>>;
    Orienteermap orienteermap_;

    // datastructure of a route
    map<string, class route*> routesdata_;
